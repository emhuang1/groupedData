...
##FUNCTIONS##
############################################################################################################################################
##The following functions are used when generating continuous failure time
...
trueBeta <- 0.2 ##treatment effect
n <- 2000 ##sample size of each simulated randomized trial
set.seed(seed)
...
save(nties, result, file="Beta02_n2000.Rdata")